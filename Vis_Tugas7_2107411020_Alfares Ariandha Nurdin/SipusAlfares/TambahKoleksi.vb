Public Class TambahKoleksi
    ...
    Private Sub BtnAddKoleksi_Click(sender As Object, e As EventArgs) Handles BtnAddKoleksi.Click
        ...
        If Dashboard.dataPerpus.GSnamaKoleksi.Length = 0 Or Dashboard.dataPerpus.GSfoto.Length = 0 Or Dashboard.dataPerpus.GSrakBuku.Length = 0 Then
            MsgBox("Harap isi data dengan benar", MsgBoxStyle.Critical, "Kesalahan")
        Else
            ...
            Dashboard.dataPerpus.AddKoleksiData(Dashboard.dataPerpus.GSnamaKoleksi,
